...
def test_post_add_new_pet_with_valid_data(name='Марс', animal_type='собака', age='1', pet_photo='images/mars.jpeg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.post_add_new_pet(auth_key, 'Бес', 'Бенгальский', '3', 'images/bes.jpeg')
        _, my_pets = pf.get_list_of_pets(auth_key, 'my_pets')
...
def test_update_pet_info(name='Перчик', animal_type='британский', age='8'):
...
def test_add_new_pet_without_photo_valid_data(name='Молли', animal_type='французский бульдог', age='2'):
    ...
    def test_set_photo_pet(pet_photo='images/molli.jpeg'):
...
def test_add_new_pet_incorrect_age(name='Хома', animal_type='хомяк', age='-1',
                                       pet_photo='images/homa.jpeg'):
    ...
    def test_set_photo_not_your_pet(pet_photo='images/homa.jpeg'):
